...
### Mini PCs
- **.21**: mini1 - immich Host (HP ProDesk 600 G2 Mini)
- **.22**: mini2 - nextcloud + n8n Host (HP ProDesk 600 G2 Mini)
- **.23**: mini3 - Wireguard (Client + Host) + Pi-hole Host (HP ProDesk 400 G2 Mini)

### Network Devices
- **.101**: TL-WA850RE - WiFi Extender (TP-Link Access Point)
- **.153**: TP-Link Network Switch
